#!/bin/bash
set -e -u -x
outputsource=ria+file:///cbica/projects/RBC/freesurfer_stats/HBN/fs-tabulate/output_ria#d9b36d5e-5da1-422b-a747-72ad2b58495e
cd /cbica/projects/RBC/freesurfer_stats/HBN/fs-tabulate
